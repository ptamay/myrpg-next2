...
export default function DashboardBlock() {
  const { diaAtual, indiceBlocoAtivo, jornadaPorDia, setJornadaPorDia, dadosGlobais, setDadosGlobais, setModals, setActiveData, salvarEstadoLocal, syncLoading } = useAppContext();
